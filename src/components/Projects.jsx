        ...
        <div className="grid grid-cols-3 mt-2 gap-5 text-myGray p-6 glassy">
          ...
          <div className="col-span-2">
            ...
            <p className="text-sm opacity-70">
              ...
              and manage their notes. Users can create notes with custom content
              and colors, view their existing notes, update, and delete their
              notes as required.
            </p>
            <div className="flex justify-start items-center mt-4 text-xs flex-wrap gap-2">
              <span className="rounded-[15px] mr-2 bg-secondary text-primary py-1 px-4">
        ...
        <div className="grid grid-cols-3 mt-2 gap-5 text-myGray p-6 glassy">
          ...
          <div className="col-span-2">
            ...
            <p className="text-sm opacity-70">
              ...
              the cards' positions is key to finding matching pairs as the game
              starts with all cards face down. Locate matching pairs amongst the
              cards to win. Uncovering two cards that do not match means they
              will be flipped back over, and you need to continue searching for
              matching pairs.
            </p>
            <div className="flex justify-start items-center mt-4 text-xs flex-wrap gap-2">
              <span className="rounded-[15px] mr-2 bg-secondary text-primary py-1 px-4">
